...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,100);
		...
		lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,130);
		lp.setMargins(0,0,0,0);
